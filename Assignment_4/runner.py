...
def run(EncoderGRU, DecoderGRU, Seq2Seq, train, evaluate):
    ...
    # 3.2 Vocabulary and Data Loading
    class Lang:
    ...
    for epoch in range(N_EPOCHS):
        ...
        validation_bleu = compute_validation_bleu(
            model, val_dataset, input_lang, output_lang, device, max_examples=500
        )
        ...
        print(f'\t Val. BLEU: {100.0 * validation_bleu:6.2f}')

    # 6.1 Inference
    checkpoint_path = Path('seq2seq-gru-model-without-attention.pt')
